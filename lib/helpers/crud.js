...
module.exports = function (options) {
    ...
    return {
        create: function(req, res, next){
            var promise = null;
            if(Model.create){
                promise = Model.create(_.extend({}, req.body, {created_by: req.user._id}));
            }else{
                promise = new Model(_.extend({}, req.body, {created_by: req.user._id}));
            }
            promise.then(
                doc => res.send(doc),
        ...
        get: function (req, res) {
            ...
            if(Model.schema.paths._id.instance === 'ObjectID' && mongoose.Types.ObjectId.isValid(req.params.id) === false){
